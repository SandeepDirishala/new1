/* 
 * doodle parallax - adapted from http://matthew.wagerfield.com/parallax/
 */
...
;(function(window, document, undefined) {
  ...
  function Parallax(element, options) {
    ...
    this.layers = element.getElementsByTagName("li")
  ...
  Parallax.prototype.updateLayers = function() {
    ...
    this.layers = this.element.getElementsByTagName("li")
    this.depths = [];
